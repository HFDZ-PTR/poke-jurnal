Poke Jurnal adalah website **Pokédex berbasis web** yang menampilkan data Pokémon menggunakan **PokeAPI**.  
Project ini dibuat sebagai bagian dari **tugas mata kuliah Pemrograman Web**.
